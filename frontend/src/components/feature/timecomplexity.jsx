...
function Timecomplexity({darkMode, toggleColorMode}) {
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await fetch(`${host}/api/code/generate`, {
            ...
            body: JSON.stringify({ prompt: `Identify and analyse ${inputLanguage} code for ${request} please give the time complexity of the code` })
        });
    ...
    return (
        <div>
            <setion className={darkMode ? ' dark-mode' : 'light-mode'}>
                ...
                <div className="code1">
                    <h1 className='main_header'>ULTIMATE TIME COMPLEXITY CALCULATOR</h1>
                    <div className="row">
