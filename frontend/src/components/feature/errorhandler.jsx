...
function Errorhandler({darkMode, toggleColorMode}) {
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await fetch(`${host}/api/code/generate`, {
            ...
            body: JSON.stringify({ prompt: `Find the error in the ${inputLanguage} Language code for ${request} please give error free code with its explanation` })
        });
    ...
    return (
        <div>
            <setion className={darkMode ? ' dark-mode' : 'light-mode'}>
                ...
                <div className="code1">
                    <h1 className='main_header'>ULTIMATE ERROR HANDLER</h1>
                    <div className="row">
